...
<header id="brand" data-bind="with : user">
	<div class="row">
		...
		<address>
			<span>
				<div class="row">
					<b data-bind="text : name"></b> &nbsp; <a title="安全退出系统" href="/TadpoleSMS/logout"><i class="icon-power-off small"></i></a> &nbsp;
				...
				$('#resetPasswordDialogInBrandJsp').dialog({
					...
					buttons : {
						'提交' : function() {
							...
							$.ajax({
								url : '/TadpoleSMS/resetMyPassword.action',
								method : 'POST',
								data : {
