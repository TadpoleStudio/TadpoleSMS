...
public class TestInitializationScripts {
	...
	public void testInitialMenus() {
		...
		Menu menu2 = new Menu("User Management", "/TadpoleSMS/admin/loadUser.action", "userManager");
		Menu menu3 = new Menu("System Development", "/TadpoleSMS/dev/develop.action", "develop");
